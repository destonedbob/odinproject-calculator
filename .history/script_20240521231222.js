...
function handleNumber(event) {
    ...
    let newNum = currNum + event.target.textContent;
...
function handleOperator(event) {
    if (isFirstOperator) {
        ...
        operatorSymbol = operatorMappingSymbol[event.target.id];
        operatorFunction = operatorMappingFunction[event.target.id];

        mainNumber = Number(displayScreen.textContent);
        subdisplayScreen.textContent =  + ' ' + operatorSymbol;
